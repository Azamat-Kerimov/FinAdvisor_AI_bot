...
export function HelpScreen() {
  ...
  const items: HelpItem[] = [
    ...
    },
    {
      ...
      children: (
        <p className="text-sm text-slate-800 leading-relaxed">
          Указывайте активы (счета, вклады, акции, облигации, наличные и т.д.) и долги (кредиты, займы, рассрочки). Чистый капитал = Активы − Пассивы. Данные используются для расчёта резервного фонда, прогресса целей и консультаций ИИ.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      children: (
        <p className="text-sm text-slate-800 leading-relaxed">
          Активы — сумма всех активов (счета, вклады, акции, облигации, наличные и т.д.) по последним введённым значениям. Пассивы — сумма долгов (кредиты, займы, рассрочки). Чистый капитал = Активы − Пассивы. График «Финансовый путь» показывает, как активы, пассивы и чистый капитал менялись по месяцам.
        </p>
      ),
    },
    {
