...
async def register_handlers(dp, get_or_create_user, db_pool, save_message):
    ...
    async def handle_amount(message: types.Message, state: FSMContext):
        ...
        if parsed:
            ...
            await db_pool.execute("INSERT INTO transactions (user_id, amount, category, description, created_at) VALUES ($1,$2,$3,$4,NOW())",
        ...
        try:
            ...
            await message.answer("Не смог распознать сумму, введите ещё раз или /cancel")
            return
